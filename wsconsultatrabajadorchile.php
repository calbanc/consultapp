...
if($conexion){
	...
	if(isset($_GET["IdTrabajador"])&&isset($_GET["IdEmpresa"])){
        ...
        $IdEmpresa=$_GET["IdEmpresa"];
			...
			INNER JOIN Zona z ON z.IdEmpresa=Contratos.IdEmpresa and z.IdZona=Contratos.IdZona
            where Trabajador.IdEmpresa='{$IdEmpresa}' and Trabajador.IdTrabajador='{$IdTrabajador}' and Contratos.IndicadorVigencia='1'";
