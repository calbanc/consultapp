...
if($conexion){
	$json=array();
	if(isset($_GET["COD_TEM"])&&isset($_GET["COD_EMP"])&&isset($_GET["COD_PACK"])&&isset($_GET["ZON"])){
		...
		$consulta="SELECT E.COD_TEM,E.COD_EMP,CONVERT(varchar,E.FECHA_RPA,23) as FECHA,E.COD_PACK,E.COD_PRO,P.NOM_PRO,E.COD_FRI,E.COD_ESP,ES.NOM_ESP,E.COD_VAR,V.NOM_VAR,E.LOTE,E.COD_ENV,E.ZON,E.CANTIDAD,E.KILOS,E.TOTAL_KILOS,E.COD_PRE,E.COD_CUA
        FROM EXISPACK E 
        ...
        where E.COD_TEM='{$COD_TEM}' AND E.COD_EMP='{$COD_EMP}' AND E.COD_PACK='{$COD_PACK}' AND E.ZON='{$ZON}' ";
