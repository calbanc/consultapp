...
if($conexion){
	$json=array();
	if(isset($_GET["fechaactividad"])&&isset($_GET["idzona"])&&isset($_GET["IdCuartel"])){
		...
		$consulta="UPDATE ActividadTrabajadorAndroid SET SW_VALIDADO='1'  WHERE  CONVERT(VARCHAR,FechaActividad,23)='{$fechaactividad}' AND IdZona='{$idzona}' and IdCuartel='{$IdCuartel}' " .$sqlwhere."";
