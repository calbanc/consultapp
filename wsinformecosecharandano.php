...
if($conexion){
	...
	if(isset($_GET["fecha"])&&isset($_GET["usuariocon"])){
        ...
        INNER JOIN bsis_rem_afr.dbo.Trabajador T ON T.usuariosis=ACHD.USUARIO
        WHERE FECHA='{$FECHA}' ".$where." GROUP BY t.ApellidoPaterno,t.ApellidoMaterno,t.Nombre,ENV.NOM_ENV  ORDER BY t.ApellidoPaterno,t.ApellidoMaterno,t.Nombre ";
