...
if($conexion){
	...
	if(isset($_GET["cod_emp"])&&isset($_GET["cod_tem"])){
		...
		$consulta="SELECT p.COD_EMP,p.COD_TEM,p.COD_PRO,pr.NOM_PRO,p.COD_PRE,c.COD_CUA,c.DESCRIPCION,c.COD_VAR,v.NOM_VAR,e.COD_ESP,e.NOM_ESP,PRI.COD_INSCRIPCION
        from predios p 
