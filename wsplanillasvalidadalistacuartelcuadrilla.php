...
if($conexion){
	$json=array();
	if(isset($_GET["idzona"])&&isset($_GET["fechaactividad"])&&isset($_GET["IdCuartel"])&&isset($_GET["IdCuartel"])&&isset($_GET["IdCuadrilla"])){
        ...
        where act.idzona='{$idzona}' and Convert(date,act.fechaactividad)='{$fechaactividad}' and act.IdCuartel='{$IdCuartel}'  and act.IdCuadrilla='{$IdCuadrilla}' and  act.SW_VALIDADO ='1'
