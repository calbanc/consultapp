...
if($conexion){
	$json=array();
	if(isset($_GET["idzona"])&&isset($_GET["fechaactividad"])&&isset($_GET["IdCuartel"])){
        ...
        cu.IdTrabajador_Enc,tr.nombre,tr.apellidopaterno,tr.apellidomaterno,act.Ciclo,act.USUARIO,act.COD_BUS,act.ETAPA,act.POR_TAREA,act.PLANILLA AS IDPLANILLAANDROID,act.SW_VALIDADO,count(act.idtrabajador)as cantidadTrabajadores,sum(act.unidadproducida) as rendimientoTotal
        ...
        where act.idzona='{$idzona}' and Convert(date,act.fechaactividad)='{$fechaactividad}' and act.IdCuartel='{$IdCuartel}' and act.SW_VALIDADO is null 
        ...
        act.ETAPA,act.POR_TAREA,act.PLANILLA,act.SW_VALIDADO";
