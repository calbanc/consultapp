...
if($conexion){
	...
	if(isset($_GET["idzona"])&&isset($_GET["fechaactividad"])&&isset($_GET["IdCuartel"])&&isset($_GET["IdCuadrilla"])){
        ...
        cu.IdTrabajador_Enc,tr.nombre,tr.apellidopaterno,tr.apellidomaterno,act.Ciclo,act.USUARIO,act.COD_BUS,act.ETAPA,act.POR_TAREA,
        ...
        where act.idzona='{$idzona}' and Convert(date,act.fechaactividad)='{$fechaactividad}' and act.IdCuartel='{$IdCuartel}' and act.IdCuadrilla='{$IdCuadrilla}' and act.SW_VALIDADO is null 
        ...
        act.ETAPA,act.POR_TAREA,act.SW_VALIDADO";
