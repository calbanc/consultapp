    ...
    ini_set('mssql.charset', 'UTF-8');
        if($conexion){
            ...
            &&isset($_GET["IdUsuario"])){
                ...
                $consulta="INSERT INTO ANDROID_RONDIN (IdEmpresa, IdTrabajador, Fecha, Hora, IdPredio, IDCuartel, Sw_Cumple, Sw_Inicio, Observacion, Latitud, Longitud,IdUsuario,swruta,idruta)                    
                VALUES ('{$IdEmpresa}', '{$IdTrabajador}', '{$Fecha}', '{$Hora}', '{$IdPredio}', '{$IDCuartel}','{$Sw_Cumple}', '{$Sw_Inicio}', '{$Observacion}', '{$Latitud}','{$Longitud}','{$IdUsuario}','{$swruta}','{$idruta}')";
