...
if($conexion){
	$json=array();
	if(isset($_GET["idzona"])&&isset($_GET["fechaactividad"])&&isset($_GET["IdEmpresa"])&&isset($_GET["IDPLANILLAANDROID"])
    &&isset($_GET["Temporada"])&&isset($_GET["Temporada"])&&isset($_GET["Idcuadrilla"])){
        ...
        WHERE act.IdEmpresa='{$IdEmpresa}' and act.Temporada='{$Temporada}' and act.idzona='{$idzona}' and Convert(date,act.fechaactividad)='{$fechaactividad}' and act.IDPLANILLAANDROID='{$IDPLANILLAANDROID}' 
